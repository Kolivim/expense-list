...
public class MonthExpensePlanningAdapter extends ArrayAdapter<MonthlyExpensePlanningDto> {

    private static final String TAG = "MonthExpensePlanningAdapter";

    private Context context;
    private List<MonthlyExpensePlanningDto> monthlyDtos;
    private OnItemClickListener listener;
    private int selectedPosition = -1;


    public interface OnItemClickListener {
        void onItemClick(MonthlyExpensePlanningDto dto, int position);
    }
    ...
    public MonthExpensePlanningAdapter(Context context, List<MonthlyExpensePlanningDto> monthlyDtos) {
        super(context, R.layout.list_item_month_expense_planning, monthlyDtos);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MonthlyExpensePlanningDto dto = monthlyDtos.get(position);
        ...
        */
        ...
        convertView.setOnClickListener(v -> {
            if (listener != null) {
                ...
                // Если слушатель не установлен, открываем детальную активность
                Intent intent = new Intent(context, MonthExpenseDetailActivity.class);
