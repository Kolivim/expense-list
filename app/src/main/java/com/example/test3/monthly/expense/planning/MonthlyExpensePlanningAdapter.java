...
public class MonthlyExpensePlanningAdapter extends ArrayAdapter<Expense> {

    private Context context;

//    private ArrayList<MonthlyExpensePlannyngDto> monthExpList;
    ...
    public MonthlyExpensePlanningAdapter(Context context, ArrayList<Expense> expenseList, ExpenseService expenseService) {
