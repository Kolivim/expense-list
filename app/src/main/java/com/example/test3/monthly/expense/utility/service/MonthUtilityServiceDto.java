...
/** Месячный отчёт по коммунальным платежам */
public class MonthUtilityServiceDto implements Serializable {
    ...
    /** Список показаний Meter, относящихся к указанному в Month месяцу */
...
//    private double balance;
    ...
    public MonthUtilityServiceDto() {}

    public MonthUtilityServiceDto(Month month) {this.month = month;}
    ...
    /** Пересчитывает статистику по расходам для месяца */
...
//        calculatePlannedBalance();
    ...
    public List<Meter> getMeterList() {return meterList;}
    public void setMeterList(List<Meter> meterList) {this.meterList = meterList;}
